          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div className="text-center">
              ...
              <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
                Explore comprehensive demos of WindVane APIs, common libraries, and best practices
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              {filteredFeatures.length} categor{filteredFeatures.length !== 1 ? 'ies' : 'y'} available
            </p>
          </div>
